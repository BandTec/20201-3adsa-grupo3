    ...
    return (
      <section>
        ...
        <div className="dropdown">
          ...
          {/* <div className="flex justcon-sb width-100pg height-240p">
            <ClickAwayListener onClickAway={handleClickAway}>

              <div className={classes.root}>
                <button type="button" className="bg-color-blue font-color-white border-rd-10 height-40p fs-16p" onClick={handleClick}>
                  Causas
                </button>
                {this.state.open ? (
                <div className="overflow-y-scroll height-55pg">
                  <div className={classes.dropdownCauses}>

                    {/* <scroll-container className="bg-color-blue">
            ...
            {/* <ClickAwayListener onClickAway={handleClickAwayLocation}>
              <div className={classesLocation.root}>
                <button type="button" className="bg-color-white-fc border-rd-10 height-40p fs-16p" onClick={handleClickLocation}>
                  Estado
              </button>
                {this.state.openLocation ? (
                <div className="overflow-y-scroll height-70pg">
